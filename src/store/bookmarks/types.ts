...
export const stagedBookmarksGroups = Lens.fromProp<BookmarksState>()(
  "stagedBookmarksGroups",
)
export const limitNumRendered = Lens.fromProp<BookmarksState>()(
  "limitNumRendered",
)
export const focusedBookmarkIndex = Lens.fromProp<BookmarksState>()(
  "focusedBookmarkIndex",
)
export const bookmarkEditId = Lens.fromProp<BookmarksState>()("bookmarkEditId")
export const bookmarkDeleteId = Lens.fromProp<BookmarksState>()(
  "bookmarkDeleteId",
)
export const stagedBookmarksGroupEditId = Lens.fromProp<BookmarksState>()(
  "stagedBookmarksGroupEditId",
)
export const stagedBookmarksGroupBookmarkEditId = Lens.fromProp<BookmarksState>()(
  "stagedBookmarksGroupBookmarkEditId",
)
export const displayDeleteBookmarkModal = Lens.fromProp<BookmarksState>()(
