...
import {
  initiateBookmarkEdit,
  initiateBookmarkDeletion,
...
const BookmarksList: FC = () => {
  ...
  useListenToKeydown(evt => {
    ...
    if (evt.key === "ArrowUp") {
      ...
      if (activeBookmarkEl && activeBookmarkEl.current)
        runIO(scrollToEl(activeBookmarkEl.current))
    }
