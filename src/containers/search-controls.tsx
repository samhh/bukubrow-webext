...
import {
  setDisplayOpenAllBookmarksConfirmation,
  setPage,
...
const SearchControls: FC = () => {
  ...
  const stagedGroups = useSelector(
    state => state.bookmarks.stagedBookmarksGroups,
  )
  ...
  const tooltipMessage = (state: HoverState): string => {
    switch (state) {
      case HoverState.Stage:
        return "Open staging area"
      case HoverState.OpenAll:
        return matchesTerminology(numFilteredBookmarks)
      case HoverState.Add:
      ...
      <ControlsWrapper>
        <div>
          <ControlButton
            ...
            onMouseEnter={
              shouldEnableOpenStaged ? showTooltip(HoverState.Stage) : undefined
            }
          ...
          <ControlButton
            ...
            onClick={(): void =>
              void dispatch(setDisplayOpenAllBookmarksConfirmation(true))
            }
            onMouseEnter={
              shouldEnableOpenAll ? showTooltip(HoverState.OpenAll) : undefined
            }
            onMouseLeave={hideTooltip}
          >
          ...
          <ControlButton
            ...
            onMouseEnter={
              shouldEnableAddBookmark ? showTooltip(HoverState.Add) : undefined
            }
            onMouseLeave={hideTooltip}
          >
